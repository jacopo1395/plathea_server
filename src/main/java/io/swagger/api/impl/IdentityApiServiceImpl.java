...
public class IdentityApiServiceImpl extends IdentityApiService {
    @Override
    public Response addIdentity(Body2 body, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response updateIdentity(Integer identityID, Body1 body, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
